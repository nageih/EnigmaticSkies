ServerEvents.recipes((event) => {
    ...
    const upgrades = [
        ...
        { item: 'industrialforegoing:speed_addon_tier_1', matrix: 4 },
        { item: 'industrialforegoing:speed_addon_tier_2', matrix: 8 },

        { item: 'industrialforegoing:efficiency_addon_tier_1', matrix: 4 },
        { item: 'industrialforegoing:efficiency_addon_tier_2', matrix: 8 },

        { item: 'industrialforegoing:processing_addon_tier_1', matrix: 4 },
        { item: 'industrialforegoing:processing_addon_tier_2', matrix: 8 },
        ...
        { item: 'modern_industrialization:basic_upgrade', matrix: 2 },
        { item: 'modern_industrialization:advanced_upgrade', matrix: 4 },
        { item: 'modern_industrialization:turbo_upgrade', matrix: 6 },
        { item: 'modern_industrialization:highly_advanced_upgrade', matrix: 8 },
        ...
        { item: 'modularrouters:energy_upgrade', matrix: 2 },
        { item: 'modularrouters:speed_upgrade', matrix: 2 },
        { item: 'modularrouters:stack_upgrade', matrix: 2 },

        { item: 'modernindustrialrouters:lv_upgrade', matrix: 4 },
        { item: 'modernindustrialrouters:mv_upgrade', matrix: 5 },
        { item: 'modernindustrialrouters:hv_upgrade', matrix: 6 },
        { item: 'modernindustrialrouters:ev_upgrade', matrix: 7 },
        { item: 'modernindustrialrouters:superconductor_upgrade', matrix: 8 },

        { item: 'oritech:machine_speed_addon', matrix: 6 },
        { item: 'oritech:machine_efficiency_addon', matrix: 6 },
        { item: 'oritech:machine_ultimate_addon', matrix: 8 },
        { item: 'oritech:quarry_addon', matrix: 2 },
        { item: 'oritech:machine_processing_addon', matrix: 6 },
        ...
        { item: 'oritech:machine_burst_addon', matrix: 8 },

        { item: 'pneumaticcraft:security_upgrade', matrix: 1 },
        { item: 'pneumaticcraft:speed_upgrade', matrix: 4 },
        { item: 'pneumaticcraft:volume_upgrade', matrix: 2 },

        { item: 'ppfluids:fluid_limiter_module', matrix: 1 },

        { item: 'ppfluids:low_fluid_extraction_module', matrix: 1 },
        { item: 'ppfluids:medium_fluid_extraction_module', matrix: 2 },
        { item: 'ppfluids:high_fluid_extraction_module', matrix: 4 },

        { item: 'ppfluids:low_fluid_filter_module', matrix: 1 },
        { item: 'ppfluids:medium_fluid_filter_module', matrix: 2 },
        { item: 'ppfluids:high_fluid_filter_module', matrix: 4 },

        { item: 'ppfluids:low_fluid_retrieval_module', matrix: 1 },
        { item: 'ppfluids:medium_fluid_retrieval_module', matrix: 2 },
        { item: 'ppfluids:high_fluid_retrieval_module', matrix: 4 },
        ...
        { item: 'prettypipes:medium_crafting_module', matrix: 2 },
        { item: 'prettypipes:high_crafting_module', matrix: 4 },

        { item: 'prettypipes:low_extraction_module', matrix: 1 },
        { item: 'prettypipes:medium_extraction_module', matrix: 2 },
        { item: 'prettypipes:high_extraction_module', matrix: 4 },

        { item: 'prettypipes:low_filter_module', matrix: 1 },
        { item: 'prettypipes:medium_filter_module', matrix: 2 },
        { item: 'prettypipes:high_filter_module', matrix: 4 },

        { item: 'prettypipes:low_high_priority_module', matrix: 1 },
        { item: 'prettypipes:medium_high_priority_module', matrix: 2 },
        { item: 'prettypipes:high_high_priority_module', matrix: 4 },

        { item: 'prettypipes:low_low_priority_module', matrix: 1 },
        { item: 'prettypipes:medium_low_priority_module', matrix: 2 },
        { item: 'prettypipes:high_low_priority_module', matrix: 4 },

        { item: 'prettypipes:low_retrieval_module', matrix: 1 },
        { item: 'prettypipes:medium_retrieval_module', matrix: 2 },
        { item: 'prettypipes:high_retrieval_module', matrix: 4 },

        { item: 'prettypipes:low_speed_module', matrix: 1 },
        { item: 'prettypipes:medium_speed_module', matrix: 2 },
        { item: 'prettypipes:high_speed_module', matrix: 4 },

        { item: 'sophisticatedbackpacks:void_upgrade', matrix: 1 },
        { item: 'sophisticatedbackpacks:advanced_void_upgrade', matrix: 4 },

        { item: 'sophisticatedbackpacks:magnet_upgrade', matrix: 1 },
        { item: 'sophisticatedbackpacks:advanced_magnet_upgrade', matrix: 4 },

        { item: 'sophisticatedbackpacks:compacting_upgrade', matrix: 1 },
        { item: 'sophisticatedbackpacks:advanced_compacting_upgrade', matrix: 4 },
        ...
        { item: 'sophisticatedbackpacks:stack_upgrade_starter_tier', matrix: 4 },
        { item: 'sophisticatedbackpacks:stack_upgrade_tier_1', matrix: 5 },
        { item: 'sophisticatedbackpacks:stack_upgrade_tier_2', matrix: 6 },
        { item: 'sophisticatedbackpacks:stack_upgrade_tier_3', matrix: 7 },
        { item: 'sophisticatedbackpacks:stack_upgrade_tier_4', matrix: 8 },

        { item: 'sophisticatedstorage:compacting_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:advanced_compacting_upgrade', matrix: 4 },

        { item: 'sophisticatedstorage:hopper_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:advanced_hopper_upgrade', matrix: 4 },

        { item: 'sophisticatedstorage:void_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:advanced_void_upgrade', matrix: 4 },

        { item: 'sophisticatedstorage:magnet_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:advanced_magnet_upgrade', matrix: 4 },

        { item: 'sophisticatedstorage:pickup_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:advanced_pickup_upgrade', matrix: 4 },
        ...
        { item: 'sophisticatedstorage:stack_upgrade_tier_1_plus', matrix: 4 },
        { item: 'sophisticatedstorage:stack_upgrade_tier_2', matrix: 5 },
        { item: 'sophisticatedstorage:stack_upgrade_tier_3', matrix: 6 },
        { item: 'sophisticatedstorage:stack_upgrade_tier_4', matrix: 7 },
        { item: 'sophisticatedstorage:stack_upgrade_tier_5', matrix: 8 },

        { item: 'sophisticatedstorage:basic_tier_upgrade', matrix: 1 },
        { item: 'sophisticatedstorage:basic_to_copper_tier_upgrade', matrix: 2 },
        { item: 'sophisticatedstorage:basic_to_iron_tier_upgrade', matrix: 3 },
        { item: 'sophisticatedstorage:basic_to_gold_tier_upgrade', matrix: 4 },
        { item: 'sophisticatedstorage:basic_to_diamond_tier_upgrade', matrix: 5 },
        { item: 'sophisticatedstorage:basic_to_netherite_tier_upgrade', matrix: 6 },

        { item: 'sophisticatedstorage:copper_to_iron_tier_upgrade', matrix: 3 },
        { item: 'sophisticatedstorage:copper_to_gold_tier_upgrade', matrix: 4 },
        { item: 'sophisticatedstorage:copper_to_diamond_tier_upgrade', matrix: 5 },
        { item: 'sophisticatedstorage:copper_to_netherite_tier_upgrade', matrix: 6 },

        { item: 'sophisticatedstorage:iron_to_gold_tier_upgrade', matrix: 4 },
        { item: 'sophisticatedstorage:iron_to_diamond_tier_upgrade', matrix: 5 },
        { item: 'sophisticatedstorage:iron_to_netherite_tier_upgrade', matrix: 6 },

        { item: 'sophisticatedstorage:gold_to_diamond_tier_upgrade', matrix: 5 },
        { item: 'sophisticatedstorage:gold_to_netherite_tier_upgrade', matrix: 6 },

        { item: 'sophisticatedstorage:diamond_to_netherite_tier_upgrade', matrix: 6 }
    ];
