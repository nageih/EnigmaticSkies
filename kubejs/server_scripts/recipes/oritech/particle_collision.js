...
ServerEvents.recipes((event) => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            ingredients: [{ item: 'enigmatica:luminiferous_aether_bottle' }, { tag: 'c:tokens/greater_earth' }],
            time: 10000,
        ...
        },
        {
            ...
            ingredients: [{ item: 'enigmatica:luminiferous_aether_bottle' }, { tag: 'c:tokens/greater_water' }],
            time: 10000,
