ItemEvents.modifyTooltips((event) => {
  ...
  const recipes = [
    ...
    },
    {
      ...
      text: [
        Text.of(`Arcane Instrument: Visualizes Apparatus Effect Area`).green(),
      ],
    },
    {
      items: [
    ...
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Blocked Attacks Boost Spell Damage and Mana Regen`
        ).lightPurple(),
      ],
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Converts Potions to Splash Potions`
        ).lightPurple(),
      ],
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Converts Potions to Lingering Potions`
        ).lightPurple(),
      ],
    },
    {
      ...
      text: [
        Text.of(`Arcane Instrument: Converts Items to Source`).lightPurple(),
      ],
    },
    {
    ...
    },
    {
      ...
      text: [
        Text.of(`Arcane Instrument: Allows the Wearer to Hover`).lightPurple(),
      ],
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Grants Random Potion Effects`
        ).lightPurple(),
      ],
    },
    {
    ...
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Increases Personal Mana Pool`
        ).lightPurple(),
      ],
    },
    {
      ...
      text: [
        Text.of(
          `Arcane Instrument: Increases Personal Mana Regen Rate`
        ).lightPurple(),
      ],
    },
    {
    ...
    {
      items: [
        "occultism:chalk_light_gray",
        "occultism:chalk_gray",
